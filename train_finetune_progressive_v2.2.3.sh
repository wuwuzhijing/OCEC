...
# 微调输出目录
OUTPUT_DIR="runs/ocec_hq_finetune_progressive_v2.2.3"
...
nohup bash -c "source $(conda info --base)/etc/profile.d/conda.sh && conda activate deploy && exec -a fprog223 python - << 'EOF'
import os, shlex
